...
def run_test_unsorted(
    ...
    while q < stop:
        ...
        result = test.top_k(query=query_doc[q], documents=document_set, top_k=10, pivots=p, group_size=x, pivot_selection_method= selection_method, tournament_filter=[True, 1295, 100, 10], embedding_path= embedding_path,
