...
#Confirm Later
import sys
run_test_unsorted('../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/rankzephyr', f'../tfilter/bier_tfilter_result_{int(sys.argv[2])}_25.csv', int(sys.argv[1]), 10, int(sys.argv[3]), 25)
