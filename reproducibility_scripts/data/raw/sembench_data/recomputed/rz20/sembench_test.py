...
#gt = gen_ground_truth(sys.argv[5], sys.argv[6], sys.argv[7])
#evaluate_results(gt, df, metric, sys.argv[1])
#evaluate_results(gt, df, metric, sys.argv[2])
run_recompute('../../sort', 20, False, sys.argv[2], '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), '../../../../models_and_benchmarks/movies/Q9.sql', sys.argv[3], "")