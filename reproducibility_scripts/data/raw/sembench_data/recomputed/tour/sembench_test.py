...
run_recompute('../../tour', 20, True, sys.argv[2], '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), '../../../../models_and_benchmarks/movies/Q9.sql', sys.argv[3], "")