...
def sort_evaluator(
    ...
    for r in formatted_results:
        ...
        df.to_csv(f'bier_sorted_10_1_1_128_2.csv', index=False)
    try:
        with open(f"bier_formatted_1_1_128_2_25.json", 'w') as f:
    ...
    temp.to_csv(f'bier_metrics_1_1_128_2_10_25.csv', index=False)
...
sort_evaluator('../../5000w/bier_result_unsorted_E_128_25_A.csv', '../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), 1, 1, 2, 2, 25)