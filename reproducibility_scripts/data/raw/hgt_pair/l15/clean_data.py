...
def sort_evaluator(
    ...
    for r in formatted_results:
        ...
        df.to_csv(f'bier_sorted_10_16_2_15_2.csv', index=False)
    try:
        with open(f"bier_formatted_16_2_15_2_25.json", 'w') as f:
    ...
    temp.to_csv(f'bier_metrics_16_2_15_2_10_25.csv', index=False)
...
sort_evaluator('../../tour_15-b/bier_result_unsorted_16_2_25.csv', '../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), 1, 1, 2, 2, 25)