...
def sort_evaluator(
    ...
    test = GenMultiPivot_sort(model_path=mpath, n_devices=device_num, window_size = w)
    data = []
    formatted = {}
    time_sum = 0.0
...
sort_evaluator('bier_result_unsorted_zephyr7b_16_2_25.csv', '../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/qwen', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), 16, 2, 20, 2, 25)