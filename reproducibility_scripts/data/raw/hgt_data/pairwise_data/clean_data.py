...
def sort_evaluator(
    ...
    for r in formatted_results:
        ...
        df.to_csv(f'bier_sorted_10_1_1_2_2.csv', index=False)
    try:
        with open(f"bier_formatted_1_1_2_2_25.json", 'w') as f:
    ...
    temp.to_csv(f'bier_metrics_1_1_2_2_10_25.csv', index=False)
...
sort_evaluator('../../comparison_1_data/bier_result_unsorted_1_1_25.csv', '../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), 1, 1, 2, 2, 25)