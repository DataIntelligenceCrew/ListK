...
def sort_evaluator(
    ...
    for r in formatted_results:
        ...
        df.to_csv(f'bier_sorted_10_{p}_{x}_20_{w}.csv', index=False)
    try:
        with open(f"bier_formatted_{p}_{x}_20_{w}_{test_num}.json", 'w') as f:
    ...
    temp.to_csv(f'bier_metrics_{p}_{x}_20_{w}_10_{test_num}.csv', index=False)
...
sort_evaluator('../5000e/bier_result_unsorted_16_2_25.csv', '../../../../models_and_benchmarks/scifact', '../../../../models_and_benchmarks/rankzephyr', "../../../../models_and_benchmarks/em_model", int(sys.argv[1]), 16, 2, int(sys.argv[2]), 25)