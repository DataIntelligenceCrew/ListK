...
class GenMultiPivot():
    ...
    def pivot_selection(
        ...
        if len(pivot_list) == 1:
            return pivot_list
        GenMultiPivot.call_count = GenMultiPivot.call_count + 1
    ...
    def organize_documents(
        ...
        GenMultiPivot.call_count = GenMultiPivot.call_count + len(organized_documents)
        counter = 0
        batched_documents = []
        current_batch = []
    ...
    def top_k_ne(
        ...
        while len(definitely_set) != top_k or maybe_set != []:
            ...
            GenMultiPivot.maybe_set_size.append(len(maybe_set))
            GenMultiPivot.latency.append(time.perf_counter() - GenMultiPivot.start_time_total)
            GenMultiPivot.call_counts.append(GenMultiPivot.call_count)
            GenMultiPivot.definitely_set_size.append(len(definitely_set))
            GenMultiPivot.intermediary_definitely_set.append(list(definitely_set.copy()))
    ...
    def top_k(
        ...
        GenMultiPivot.intermediary_definitely_set = [[]]
        GenMultiPivot.latency = [0.0]
        GenMultiPivot.call_counts = [0]
        GenMultiPivot.call_count = 0
        ...
        GenMultiPivot.maybe_set_size.append(len(documents))
        GenMultiPivot.latency.append(time.perf_counter() - GenMultiPivot.start_time_total)
        GenMultiPivot.call_counts.append(GenMultiPivot.call_count)
        GenMultiPivot.definitely_set_size.append(0)
        GenMultiPivot.intermediary_definitely_set.append([])
        if early_stop:
            ...
            GenMultiPivot.maybe_set_size.append(0)
            GenMultiPivot.latency.append(time.perf_counter() - GenMultiPivot.start_time_total)
            GenMultiPivot.call_counts.append(GenMultiPivot.call_count)
            GenMultiPivot.definitely_set_size.append(len(result))
            GenMultiPivot.intermediary_definitely_set.append(result.copy())
            return result
        else:
